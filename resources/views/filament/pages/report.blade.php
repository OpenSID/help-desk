    ...
    <div class="!mt-[0px]">
        ...
        <div class="mb-4 border-b border-gray-200">
            <nav class="-mb-px flex space-x-8 overflow-auto">
                ...
                <button wire:click="$set('activeTab', 4)" class="{{ $activeTab === 4 ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">{{ __('Ticket by service') }}</button>
                <button wire:click="$set('activeTab', 5)" class="{{ $activeTab === 5 ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">{{ __('Ticket by application') }}</button>
                <button wire:click="$set('activeTab', 6)" class="{{ $activeTab === 6 ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">{{ __('Ticket duplicates') }}</button>
            </nav>
        </div>
        ...
        <div>
            ...
            @elseif($activeTab === 4)
                @livewire(\App\Filament\Widgets\TicketByServiceChart::class, [], key('ticket-by-service'))
            @elseif($activeTab === 5)
                @livewire(\App\Filament\Widgets\TicketByApplicationChart::class, [], key('ticket-duplicate'))
            @elseif($activeTab === 6)
